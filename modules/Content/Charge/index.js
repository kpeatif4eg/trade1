    ...
    <div class="wallet-section">
        <div class="wallet-block wallet-block--info 1">
          ...
          <div class="wallet-block__card wallet-card">
            ...
            <div class="wallet-card__rate" data-count="0.0"> 0.0
        ...
        <div class="wallet-block wallet-block--info 2">
          ...
          <div class="wallet-block__card wallet-card">
            ...
            <div class="wallet-card__rate Bitt" style="width: 200px; margin-right: 59px" data-count="0.0"> 0.0

            </div>
            <div class="wallet-card__wrapper-update">
              <button class="wallet-card__update check">ХЭШ</button>
            </div>
          </div>
        </div>
